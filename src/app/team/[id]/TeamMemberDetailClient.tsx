...
const TeamMemberDetailClient = ({ params }: PageProps) => {
    const { id } = use(params);
    ...
    useEffect(() => {
        const fetchMember = async () => {
            try {
                // For simplicity assuming single ID fetch or filter
                    ...
                    <div className="flex flex-col md:flex-row gap-16 items-start">
                        ...
                        <div className="flex-grow">
                            ...
                            <div className="flex gap-4">
                                ...
                                {member.socialLinks?.instagram && <a href={member.socialLinks.instagram} className="w-10 h-10 border border-white/10 flex items-center justify-center text-gray-400 hover:text-primary hover:border-primary transition-all"><Twitter size={18} /></a>}
...
export default TeamMemberDetailClient;
